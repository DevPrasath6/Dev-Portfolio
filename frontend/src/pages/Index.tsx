...
import { CV, Education, Achievement } from "@/components/portfolio/CV";
...
const defaultEducation: Education[] = [
  { id: "1", degree: "Master of Computer Science", field: "Software Engineering & AI", institution: "Stanford University", location: "California, USA", period: "2016 - 2018", gpa: "3.9/4.0", achievements: ["Dean's List", "Research Assistant"] },
  { id: "2", degree: "Bachelor of Computer Science", field: "Computer Science", institution: "MIT", location: "Massachusetts, USA", period: "2012 - 2016", gpa: "3.8/4.0", achievements: ["Honors Graduate", "Hackathon Winner"] },
];

const defaultAchievements: Achievement[] = [
  { id: "1", title: "Best Innovation Award", description: "Recognized for developing an AI-powered code review system", date: "2023", type: "award" },
  { id: "2", title: "Open Source Contributor", description: "Top contributor to major React ecosystem libraries", date: "2022", type: "recognition" },
  { id: "3", title: "Tech Conference Speaker", description: "Keynote speaker at ReactConf and NodeConf", date: "2023", type: "recognition" },
  { id: "4", title: "Patent Holder", description: "Patent for real-time collaborative editing algorithm", date: "2021", type: "other" },
];
